...
class PathEncoder(json.JSONEncoder):
    """
    JSONEncooder extension to support pathlib.Path serialization.
    """
...
class Benchmark:
    ...
    def __init__(
        ...
        encoder_cls: Type[json.JSONEncoder] = PathEncoder,
    ) -> None:
        ...
        self._encoder_cls: Type[json.JSONEncoder] = encoder_cls
        ...
        for run_id in range(1, self._nb_runs + 1):
            ...
            wrdr(
                file_content=json.dumps(
                    experiment_results_lines, indent=4, cls=self._encoder_cls
                ).strip()
                + "\n",
